...
typedef enum{
	TRANSFER_COMPLETE_S0	=	5,
	TRANSFER_COMPLETE_S1	=	11,
	TRANSFER_COMPLETE_S2	=	21,
	TRANSFER_COMPLETE_S3	=	27,
	TRANSFER_COMPLETE_S4	=	0x85, // 5 with MSB equals 1
	TRANSFER_COMPLETE_S5	=	0x8B, // 11 with MSB equals 1
	TRANSFER_COMPLETE_S6	=	0x95, // 21 with MSB equals 1
	TRANSFER_COMPLETE_S7	=	0x9B // 27 with MSB equals 1
}TransCompleteInt;
...
typedef enum{
	...
	HALF_TRANSFER_S2	=	20,
	HALF_TRANSFER_S3	=	26,
	HALF_TRANSFER_S4	=	0x84, // 5 with MSB equals 1
	HALF_TRANSFER_S5	=	0x8A, // 11 with MSB equals 1
	HALF_TRANSFER_S6	=	0x94, // 21 with MSB equals 1
	HALF_TRANSFER_S7	=	0x9A // 27 with MSB equals 1

}HalfTransCompleteInt;
...
typedef enum {
	...
	TRANSFER_ERROR_S0	=		3,
	TRANSFER_ERROR_S1	=		9,
	TRANSFER_ERROR_S2	=		19,
	TRANSFER_ERROR_S3	=		25,
	TRANSFER_ERROR_S4	=		0x83, // 3 with MSB equals 1
	TRANSFER_ERROR_S5	=		0x89, // 9 with MSB equals 1
	TRANSFER_ERROR_S6	=		0x93, // 19 with MSB equals 1
	TRANSFER_ERROR_S7	=		0x99 // 25 with MSB equals 1
}TransError;
...
StatusReport_t DMA_GetTransferState(HalfTransCompleteInt halfComp, TransCompleteInt comp, TransError errorInt);
